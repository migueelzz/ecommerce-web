...
const buttonVariants = tv({
  base: [
    'min-h-10 min-w-10 rounded-md font-semibold outline-none transition flex items-center justify-center gap-2',
  ...
  variants: {
    variant: {
      primary: 'bg-zinc-900 text-white [&:not(:disabled)]:hover:opacity-80',
      secondary:
